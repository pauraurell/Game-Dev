...
void j1Scene::Create2MapCoins()
{
	...
	coin4 = App->entManager->CreateEntity(j1Entities::Types::coin, { 720, 175 }, false, true);
	...
	coin9 = App->entManager->CreateEntity(j1Entities::Types::coin, { 767, 95 }, false, true);
	coin10 = App->entManager->CreateEntity(j1Entities::Types::coin, { 1360, 235 }, false, true);
	coin11 = App->entManager->CreateEntity(j1Entities::Types::coin, { 1280, 93 }, false, true);
	coin12 = App->entManager->CreateEntity(j1Entities::Types::coin, { 905, 78 }, false, true);
	coin13 = App->entManager->CreateEntity(j1Entities::Types::coin, { 1057, 60 }, false, true);
	coin14 = App->entManager->CreateEntity(j1Entities::Types::coin, { 1185, 60 }, false, true);
	coin15 = App->entManager->CreateEntity(j1Entities::Types::coin, { 850, 150 }, false, true);
