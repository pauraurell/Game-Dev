...
{
	BROFILER_CATEGORY("Render_PostUpdate", Profiler::Color::NavajoWhite)
...
// Blit to screen
bool j1Render::Blit(SDL_Texture* texture, int x, int y, const SDL_Rect* section, SDL_RendererFlip flip_texture, float speedX, float speedY, double angle, int pivot_x, int pivot_y) const
{
	bool ret = true;
